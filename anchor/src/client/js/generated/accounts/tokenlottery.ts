...
export function getTokenlotteryDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(TOKENLOTTERY_DISCRIMINATOR);
}
...
export function getTokenlotteryEncoder(): Encoder<TokenlotteryArgs> {
...
export function getTokenlotteryDecoder(): Decoder<Tokenlottery> {
...
export function getTokenlotteryCodec(): Codec<TokenlotteryArgs, Tokenlottery> {
